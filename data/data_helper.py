...
def get_train_dataloader(dataset_list, jig_classes, batch_size=128, image_size=225, val_size=0.0, bias_whole_image=None, patches=False):
    ...
    for dname in dataset_list:
        ...
        datasets.append(JigsawDataset(name_train, labels_train, patches=patches, image_size=image_size,
...
def get_val_dataloader(dataset_name, jig_classes, batch_size=128, image_size=225, multi=False, patches=False):
    ...
    if multi:
        ...
        dataset = ConcatDataset([JigsawTestDataset(names, labels, patches=patches, image_size=image_size, classes=jig_classes)])
